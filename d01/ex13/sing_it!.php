...
if ($argv[1] == 'mais pourquoi cette demo ?') {
	echo 'Tout simplement pour qu\'en feuilletant le sujet'.PHP_EOL.'on se s\'apercoive pas de la nature de l\'exo'.PHP_EOL;
}
	...
	if (rand(0, 1))
		echo 'Nan c\'est parceque c\'est le premier avril'.PHP_EOL;
	else
